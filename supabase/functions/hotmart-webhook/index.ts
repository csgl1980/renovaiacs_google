...
const creditProductMapping: { [hotmartProductId: string]: number } = {
  "6243393": 50,  // ID do produto Hotmart para o Pacote Básico (50 créditos)
  "6243679": 100,  // ID do produto Hotmart para o Pacote Padrão (100 créditos)
  "6243722": 300, // ID do produto Hotmart para o Pacote Profissional (300 créditos)
